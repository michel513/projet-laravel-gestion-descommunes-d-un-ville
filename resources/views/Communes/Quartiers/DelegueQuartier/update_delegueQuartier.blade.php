...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                <h1 class="text-center">Modifier un Delegue de Quartier</h1>
                <hr>
                ...
                <form action="/lister-quartier/{{$commune}}/lister-delegueQuartier/{{$quartier->IdQuartier}}/update-quartier/{{$delegueQuartier->IdDelegue}}/traitement" method="POST" class="from-group">
                    @csrf
                    <div class="mb-3">
                        <label for="IdDelegue" class="form-label">Id Delegue Quartier</label>
                        <input type="text" class="form-control" id="IdDelegue" name="IdDelegue" value="{{$delegueQuartier->IdDelegue}}" readonly>
                    </div>
                    Id Habitant :
                    ...
                    <button type="submit" class="btn btn-primary">Modifier le Delegue Quartier</button>
